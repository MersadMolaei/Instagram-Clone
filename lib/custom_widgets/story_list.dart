    ...
    return Container(
      ...
      child: Column(
        children: [
          Stack(
            children: [
              story.isViewed? ProfileStoryViewed(story: story): ProfileStoryNotViewed(story: story),
              ...
              Positioned(
                ...
                right: 0,
                bottom: -1, // -5
                child: story.isLive? Assets.icons.live.svg(height: 19, width: 29): const SizedBox(),
              ),
            ],
          ),
          const SizedBox(
...
class ProfileImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
        ...
        child:
            Image.asset(story.imageFileName));
  }
}